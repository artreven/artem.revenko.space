"""
Django settings for jelena_revenko_space project.
...
# Uncomment to Add apps/ to the Python path
...
ROOT_URLCONF = 'artem_revenko_space.urls'
...
WSGI_APPLICATION = 'artem_revenko_space.wsgi.application'
